        ...
        <div className="bg-light">
            ...
            <div className="border col" id="floor-div">
                <div className={floorsState[8].isElv && floorsState[8].elevatorId.includes(elvId) ? "d-inline" : "d-none"}>
                    ...
                    <div><Icon id="elevator-icon" className={floorsState[8].isElv && floorsState[8].elevatorId.includes(elvId) ? (elevatorsState[elvId].inAction ? "text-red d-inline" : (floorsState[8].isArrived ? "text-green d-inline" : "text-black d-inline")) : "d-none"} />
                    </div>
                </div>
            </div>
            <div className="border col" id="floor-div">
